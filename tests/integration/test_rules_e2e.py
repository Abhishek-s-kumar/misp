...
def e2e_rules_env(tmp_path, monkeypatch):
    ...
    shutil.copytree(str(Path(__file__).resolve().parent.parent.parent / "ansible"), tmp_path / "ansible")
    ...
    venv_bin = str(Path(__file__).resolve().parent.parent.parent / ".venv" / "bin")
